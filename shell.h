...
/* Flag indicating the use of system getline() */
...
/**
 * Structure containing information to pass into functions.
 */
typedef struct passinfo
{
    ...
    char **cmd_buf; /* Address of pointer to command buffer for chaining */
...
/**
 * Structure for built-in commands and related functions.
 */
